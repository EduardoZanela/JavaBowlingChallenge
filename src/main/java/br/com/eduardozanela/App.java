...
import br.com.eduardozanela.service.implementation.PlayerServiceScoreImpl;
...
public class App{
    ...
    public static void main( String[] args ){
    	PlayerScoreService playerServiceScore = new PlayerServiceScoreImpl();
        ...
        try {
			...
			playerServiceScore.generatePlayerScoreBoard(commandLine.getOptionValue("f"));
